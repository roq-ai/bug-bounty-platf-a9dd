...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'admin', 'hacker', 'business', 'agency', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Bounty', path: '/bounties', entity: 'bounty', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
      name: 'Leaderboard',
      path: '/leaderboards',
      entity: 'leaderboard',
