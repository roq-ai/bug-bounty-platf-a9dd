      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="scope" mb="4" isInvalid={!!formik.errors?.scope}>
              <FormLabel>Scope</FormLabel>
              <Input type="text" name="scope" value={formik.values?.scope} onChange={formik.handleChange} />
              {formik.errors.scope && <FormErrorMessage>{formik.errors?.scope}</FormErrorMessage>}
            </FormControl>
